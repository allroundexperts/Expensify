    ...
    render() {
        ...
        return (
            <>
                ...
                {currentAuthState === CONST.AUTO_AUTH_STATE.NOT_STARTED && is2FARequired && !isSignedIn && (
                    <ValidateCodeModal
                        accountID={this.getAccountID()}
                        code={this.getValidateCode()}
                    />
                )}
                {currentAuthState === CONST.AUTO_AUTH_STATE.NOT_STARTED && !is2FARequired && !isSignedIn && <JustSignedInModal is2FARequired={false} />}
